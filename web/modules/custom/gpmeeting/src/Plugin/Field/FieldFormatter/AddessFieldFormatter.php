...
namespace Drupal\gpmeeting\Plugin\Field\FieldFormatter;
...
/**
 * Plugin implementation of the 'addess_field_formatter' formatter.
 *
 * @FieldFormatter(
 *   id = "addess_field_formatter",
 *   label = @Translation("City (Address), Country"),
 *   field_types = {
 *     "address"
 *   }
 * )
 */
class AddessFieldFormatter extends FormatterBase implements ContainerFactoryPluginInterface {
